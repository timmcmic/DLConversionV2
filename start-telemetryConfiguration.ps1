    ...
    Function start-telemetryConfiguration
     {
        ...
        $functionConnetionStringKey = $traceModuleName+".ApplicationInsights.InstrumentationKey"
        ...
        Set-PSFConfig -Module $functionModuleName -Name $functionConnetionStringKey -value $functionConnectionString -Initialize -validation string -Description "Connection string for api workspace."
