    ...
    Function start-telemetryConfiguration
     {
        ...
        $functionConnectionString = "InstrumentationKey=63d673af-33f4-401c-931e-f0b64a218d89;IngestionEndpoint=https://eastus2-3.in.applicationinsights.azure.com/;LiveEndpoint=https://eastus2.livediagnostics.monitor.azure.com/"
        ...
        Set-PSFConfig -Module $functionModuleName -Name $functionConnectionStringKey -value "InstrumentationKey=63d673af-33f4-401c-931e-f0b64a218d89;IngestionEndpoint=https://eastus2-3.in.applicationinsights.azure.com/;LiveEndpoint=https://eastus2.livediagnostics.monitor.azure.com/" -Initialize -validation string -Description "Connection string for api workspace." -Hidden
