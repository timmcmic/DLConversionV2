...
Function get-multipleDLHealthReports
{
    <#
    .SYNOPSIS
    ...
    *OPTIONAL*
    ...
    $windowTitle = "Get-MultipleDLHealthReport Controller"
    ...
    [string]$jobName="MultipleDLHealthReport"
    ...
    Out-LogFile -string "================================================================================"
    Out-LogFile -string "BEGIN GET-MULTIPLEDLHEALTHREPORT"
    Out-LogFile -string "================================================================================"
    ...
    do 
    {
        ...
        if ($remainingAddresses -ge $maxThreadCount)
        {
            ...
            for ($forCounter = 0 ; $forCounter -lt $maxThreadCount ; $forCounter ++)
            {
                ...
                Start-Job -Name $jobName -InitializationScript {import-module DLConversionV2} -ScriptBlock { Get-DLHealthReport -groupSMTPAddress $args[0] -globalCatalogServer $args[1] -activeDirectoryCredential $args[2] -activeDirectoryAuthenticationMethod $args[16] -logFolderPath $args[3] -exchangeOnlineCredential $args[4] -exchangeOnlineCertificateThumbPrint $args[5] -exchangeOnlineOrganizationName $args[6] -exchangeOnlineEnvironmentName $args[7] -exchangeOnlineAppID $args[8] -useCollectedSendAsOnPrem $args[9] -threadNumberAssigned $args[10] -totalThreadCount $args[11] -msGraphEnvironmentName $args[12] -msGraphTenantID $args[13] -msGraphCertificateThumbprint $args[14] -msGraphApplicationID $args[15] -allowTelemetryCollection $args[17] -allowDetailedTelemetryCollection $args[18] -errorMembersOnly $args[19] -includeVerboseOutput $args[20] -useCollectedFullMailboxAccessOnPrem $args[21] -useCollectedFullMailboxAccessOffice365 $args[22] -useCollectedFolderPermissionsOnPrem $args[23] -useCollectedFolderPermissionsOffice365 $args[24]} -ArgumentList $groupSMTPAddresses[$arrayLocation + $forCounter],$globalCatalogServer,$activeDirectoryCredential,$originalLogFolderPath,$exchangeOnlineCredential,$exchangeOnlineCertificateThumbPrint,$exchangeOnlineOrganizationName,$exchangeOnlineEnvironmentName,$exchangeOnlineAppID,$useCollectedSendAsOnPrem,$forThread,$loopThreadCount,$msGraphEnvironmentName,$msGraphTenantID,$msGraphCertificateThumbprint,$msGraphApplicationID,$activeDirectoryAuthenticationMethod,$allowTelemetryCollection,$allowDetailedTelemetryCollection,$errorMembersOnly,$includeVerboseOutput,$useCollectedFullMailboxAccessOnPrem,$useCollectedFullMailboxAccessOffice365, $useCollectedFolderPermissionsOnPrem,$useCollectedFolderPermissionsOffice365
                #Start-Job -Name $jobName -InitializationScript {import-module c:\repository\dlconversionv2\dlconversionv2.psd1 -force} -ScriptBlock { Get-DLHealthReport -groupSMTPAddress $args[0] -globalCatalogServer $args[1] -activeDirectoryCredential $args[2] -activeDirectoryAuthenticationMethod $args[16] -logFolderPath $args[3] -exchangeOnlineCredential $args[4] -exchangeOnlineCertificateThumbPrint $args[5] -exchangeOnlineOrganizationName $args[6] -exchangeOnlineEnvironmentName $args[7] -exchangeOnlineAppID $args[8] -useCollectedSendAsOnPrem $args[9] -threadNumberAssigned $args[10] -totalThreadCount $args[11] -msGraphEnvironmentName $args[12] -msGraphTenantID $args[13] -msGraphCertificateThumbprint $args[14] -msGraphApplicationID $args[15] -allowTelemetryCollection $args[17] -allowDetailedTelemetryCollection $args[18] -errorMembersOnly $args[19] -includeVerboseOutput $args[20] -useCollectedFullMailboxAccessOnPrem $args[21] -useCollectedFullMailboxAccessOffice365 $args[22] -useCollectedFolderPermissionsOnPrem $args[23] -useCollectedFolderPermissionsOffice365 $args[24]} -ArgumentList $groupSMTPAddresses[$arrayLocation + $forCounter],$globalCatalogServer,$activeDirectoryCredential,$originalLogFolderPath,$exchangeOnlineCredential,$exchangeOnlineCertificateThumbPrint,$exchangeOnlineOrganizationName,$exchangeOnlineEnvironmentName,$exchangeOnlineAppID,$useCollectedSendAsOnPrem,$forThread,$loopThreadCount,$msGraphEnvironmentName,$msGraphTenantID,$msGraphCertificateThumbprint,$msGraphApplicationID,$activeDirectoryAuthenticationMethod,$allowTelemetryCollection,$allowDetailedTelemetryCollection,$errorMembersOnly,$includeVerboseOutput,$useCollectedFullMailboxAccessOnPrem,$useCollectedFullMailboxAccessOffice365, $useCollectedFolderPermissionsOnPrem,$useCollectedFolderPermissionsOffice365
    ...
    Out-LogFile -string "================================================================================"
    Out-LogFile -string "END MULTIPLEDLHEALTHREPORT"
    Out-LogFile -string "================================================================================"
}
