    ...
    do 
    {
        ...
        if ($remainingAddresses -ge $maxThreadCount)
        {
            ...
            for ($forCounter = 0 ; $forCounter -lt $maxThreadCount ; $forCounter ++)
            {
                ...
                #Start-Job -Name $jobName -InitializationScript {import-module DLConversionV2} -ScriptBlock { Test-PreMigration0365Group -groupSMTPAddress $args[0] -globalCatalogServer $args[1] -activeDirectoryCredential $args[2] -activeDirectoryAuthenticationMethod $args[16] -logFolderPath $args[3] -exchangeOnlineCredential $args[4] -exchangeOnlineCertificateThumbPrint $args[5] -exchangeOnlineOrganizationName $args[6] -exchangeOnlineEnvironmentName $args[7] -exchangeOnlineAppID $args[8] -useCollectedSendAsOnPrem $args[9] -threadNumberAssigned $args[10] -totalThreadCount $args[11] -msGraphEnvironmentName $args[12] -msGraphTenantID $args[13] -msGraphCertificateThumbprint $args[14] -msGraphApplicationID $args[15] -allowTelemetryCollection $args[17] -allowDetailedTelemetryCollection $args[18] -addManagersAsMembers $args[19] -overrideSecurityGroupCheck $args[20]} -ArgumentList $groupSMTPAddresses[$arrayLocation + $forCounter],$globalCatalogServer,$activeDirectoryCredential,$originalLogFolderPath,$exchangeOnlineCredential,$exchangeOnlineCertificateThumbPrint,$exchangeOnlineOrganizationName,$exchangeOnlineEnvironmentName,$exchangeOnlineAppID,$useCollectedSendAsOnPrem,$forThread,$loopThreadCount,$msGraphEnvironmentName,$msGraphTenantID,$msGraphCertificateThumbprint,$msGraphApplicationID,$activeDirectoryAuthenticationMethod,$allowTelemetryCollection,$allowDetailedTelemetryCollection,$FALSE,$FALSE
                Start-Job -Name $jobName -InitializationScript {import-module c:\repository\dlconversionv2\dlconversionv2.psd1 -force} -ScriptBlock { Test-PreMigration0365Group -groupSMTPAddress $args[0] -globalCatalogServer $args[1] -activeDirectoryCredential $args[2] -activeDirectoryAuthenticationMethod $args[16] -logFolderPath $args[3] -exchangeOnlineCredential $args[4] -exchangeOnlineCertificateThumbPrint $args[5] -exchangeOnlineOrganizationName $args[6] -exchangeOnlineEnvironmentName $args[7] -exchangeOnlineAppID $args[8] -useCollectedSendAsOnPrem $args[9] -threadNumberAssigned $args[10] -totalThreadCount $args[11] -msGraphEnvironmentName $args[12] -msGraphTenantID $args[13] -msGraphCertificateThumbprint $args[14] -msGraphApplicationID $args[15] -allowTelemetryCollection $args[17] -allowDetailedTelemetryCollection $args[18] -addManagersAsMembers $args[19] -overrideSecurityGroupCheck $args[20]} -ArgumentList $groupSMTPAddresses[$arrayLocation + $forCounter],$globalCatalogServer,$activeDirectoryCredential,$originalLogFolderPath,$exchangeOnlineCredential,$exchangeOnlineCertificateThumbPrint,$exchangeOnlineOrganizationName,$exchangeOnlineEnvironmentName,$exchangeOnlineAppID,$useCollectedSendAsOnPrem,$forThread,$loopThreadCount,$msGraphEnvironmentName,$msGraphTenantID,$msGraphCertificateThumbprint,$msGraphApplicationID,$activeDirectoryAuthenticationMethod,$allowTelemetryCollection,$allowDetailedTelemetryCollection,$FALSE,$FALSE
